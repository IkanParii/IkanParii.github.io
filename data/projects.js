...
export const projects = [
  // Project tool yang ditampilkan di section Work.
  {
    ...
    desc:
      "Tool ringan untuk menyusun Google Dork queries secara cepat, dirancang untuk workflow OSINT dan reconnaissance yang rapi dan efisien.",
  ...
  // Writeup atau blog yang berisi dokumentasi belajar.
  {
    ...
    desc:
      "Vault writeup utama berisi analisis CTF, catatan forensik, dan dokumentasi pembelajaran cybersecurity yang dikurasi dengan gaya editorial.",
